...
def predict():
	...
	return render_template('index.html', prediction_text='L\'assurance réserve une somme de  {} $'.format(round(result[0],2)))

@app.route('/')
def index():
	return render_template('index.html', prediction_text='Saisir le formulaire pour avoir un prédiction')
